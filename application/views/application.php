...
<div class="container mt-5 mb-5">
    <div class="application-heading text-center">
        <div class="title">
            <h3>SHREE VINAYAKA POLYTECHNIC</h3>
        </div>
        <div class="sub-title">
            <h5>Coromandel post, Kolar Gold Fields, Karnataka - 563120<br>
            (Recognized by the Government of Karnataka - Affiliated to AICTE)</h5>
        </div>
    </div>
