...
$(function () {
  $.validator.setDefaults({
    submitHandler: function () {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>academic_controller/update_department",
        data: formData,
        contentType: false,
        processData: false,
        success: function(data) {
          if(data=='updated'){
            $('#error').html('<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button>Department Updated Successfully.</div>');
            setTimeout(function(){
