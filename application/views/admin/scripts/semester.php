...
$(function () {
  $.validator.setDefaults({
    submitHandler: function () {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>academic_controller/add_semester",
        data: {
        ...
        success: function(data) {
          if(data=='inserted'){
            $('#error').html('<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button>Semester Added Successfully.</div>');
            setTimeout(function(){
