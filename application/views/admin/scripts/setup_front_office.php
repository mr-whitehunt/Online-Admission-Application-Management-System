...
$(function () {
  $.validator.setDefaults({
    submitHandler: function () {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>frontoffice_controller/add_enquiry_type",
        data: {
        ...
        success: function(data) {
          if(data=='inserted')
          {
            $('#error').html('<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button>Enquiry Type Added Successfully.</div>');
            setTimeout(function(){
...
$(function () {
  $.validator.setDefaults({
    submitHandler: function () {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>frontoffice_controller/add_complaint_type",
        data: {
