      ...
      <div class="box-container">
        <div class="box text-center">
          ...
          <div class="box-content">
            <p>Please enter your email and click on continue!.</p>
            <div id="error"></div>
            <form id="grivance_start_public" action="#">
                <div class="form-group">
                    <input type="email" name="public_email" id="public_email" class="form-control" placeholder="Email">
                </div>
                <div class="form-group">
